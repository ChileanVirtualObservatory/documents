...
\begin{abstract}
Este documento trata acerca del lado computacional de un observatorio virtual,
centrándose en la capa de acceso a los datos, y como la International Virtual
Observatory Alliance maneja este aspecto en su arquitectura. Se expone el
trabajo que se está realizando en la implementación de esta área en el Chilean
Virtual Observatory.
\end{abstract}
