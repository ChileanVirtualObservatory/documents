...
% [MA] Indexed with ALMA data = indexado con data ALMA... es esto correcto?  tal
% vez "indexed by ALMA."
...
back to the user.
% [MA] Send the results back to the user in the form of a ¿VOTABLE?
...
% [MA] que significa que "no se beneficia", eso es no funciona? o no ocupa las
% caracteristicas de las nuevas versiones de postgreSQL
...
\section{MongoDB versus Postgresql performance}
    ...
    % [MA] some votables es muuuyy chafa! ;)
